...
if __name__ == '__main__':
    ...
    #colors = [cm.tab20c(i) for i in [4, 5, 6, 4, 5, 6, 16, 17, 18]]
    colors = [cm.tab20c(i) for i in [0, 1, 2, 0, 1, 2, 16, 17, 18]]
    ...
    if 'adult' in dataset:
        ...
        dataset = 'Synthetic'
    plt.title('                Bias-accuracy tradeoff with Randomized Control\n                (Dataset: %s, MI est: %s)' % (dataset, info_method), fontsize=18)
